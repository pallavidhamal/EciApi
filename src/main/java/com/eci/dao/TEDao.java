...
public interface TEDao {
	...
	ObjectNode getTERegionsList(Installation inc);
	...
	String getTestValues(String testId,int productId,String TestType,String strTestValueType);

	public ObjectNode updateTEPhotoTests(MultipartFile file,InstallationAction IA);
	
	String CheckTasksStatus(String strJobId);
	/*boolean SIAcceptJob(SI si);
	...
	void updateTaskStarted(String strJobId);
